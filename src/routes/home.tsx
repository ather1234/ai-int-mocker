    ...
    <div className="flex-col w-full pb-24">
      <Container>
        <div className="my-8">
          ...
          <p className="mt-4 text muted-foreground text-sm">
            ...
            AI-driven insights.Discover a smarter way to prepare,practise &
            stand out.
          </p>
        </div>
        <div className="flex w-full items-center justify-evenly md:px-12 md:py-16 md:items-center md:justify-end gap-12">
          <p className="text-3xl font-semibold text-grey-900 text-center">
            250+
      ...
      <div className="w-full my-12">
        <Marquee pauseOnHover>
          <MarqueImg img="/public/firebase.png" />
          <MarqueImg img="/public/meet.png" />
          <MarqueImg img="/public/zoom.png" />
          <MarqueImg img="/public/firebase.png" />
          <MarqueImg img="/public/microsoft.png" />
          <MarqueImg img="/public/meet.png" />
          <MarqueImg img="/public/tailwindcss.png" />
          <MarqueImg img="/public/microsoft.png" />
        </Marquee>
      </div>
